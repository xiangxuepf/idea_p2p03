...
<div class="headBody" id="headBody">
    ...
    <div class="mainBox clearfix">
        <div class="head_l"><span>客服电话：4000-888-178</span><em></em><a href="http://weibo.com/bjpowernode" target="_blank" class="weibo"></a></div>
                            ...
                            <div class="down-bk">
                                ...
                                <ul class="quick-entry clearfix">
                                    ...
                                    <li class="icon-invest" style="margin-left:85px;"><a
                                            href="loan/loan"><i></i><span>投资</span></a></li>
                                </ul>
...
<div id="ewm" class="ewm_layer" style="display:none;">
    ...
    <div class="ewm_weixin">
        <h3>聚金网服务号</h3>
        <h4>更多服务请关注聚金网服务号</h4>
        <div class="ewm"><img src="${pageContext.request.contextPath}/images/ewm_fwh.jpg" alt="聚金网服务号"></div>
    </div>
    <div class="ewm_weixin">
        <h3>聚金网订阅号</h3>
        <h4>获取聚金网最新资讯</h4>
        <div class="ewm"><img src="${pageContext.request.contextPath}/images/ewm_dyh.jpg" alt="聚金网订阅号"></div>
    </div>
</div>
<!-- 二维码弹出层end -->