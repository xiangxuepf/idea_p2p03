...
<title>注册聚金资本金融网-聚金资本金融网,专业的互联网金融信息服务平台</title>
</head>
        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="login-box clearfix" style="z-index:100;">
                <label>手机号</label>
                <%--autocomplete="off"其含义代表是否让浏览器自动记录之前输入的值
                onblur事件当用户离开输入字段时对其进行验证--%>
              ...
              <div class="remember" style="z-index:60;">
                <span class="on">
                <input id="agree" name="agree" type="checkbox"/>我已阅读并同意<a href="javascript:alertBox('mask','agreement');"><font style="color: red;">《聚金资本金融网&trade;注册服务协议》</font></a>
                </span>
              </div>
